 ...
 * @LastEditTime: 2020-12-08 02:08:26
 * @LastEditors: caishiyin
 * @Description:
 * @FilePath: /blog-react-ts/src/pages/Home.tsx
 */
...
const FeaturedArticlesDescription = () => (
  <div className="box-description">
    ...
    <p className="default description">Because TypeScript is a superset of JavaScript, it doesn't have a default template - there would be too many. Instead, other projects have their own TypeScript bootstrap templates with their own context. These projects provide templates which include TypeScript support.</p>
  ...
  <>
    ...
    <Row className="box-content" justify="space-around" gutter={[{ xs: 8, sm: 8, md: 24, xl: 24, xxl: 24 }, 20]}>
      <Col xs={24} sm={24} md={24} lg={8} xl={8} className="card-box">
        <Card
          cover={
            <div className="cover-img" style={firstStyle} />
          }
          className="card-item"
        >
          <Meta
  ...
  <>
    ...
    <Row gutter={[0, 40]} className="box-content" justify="space-around">
      <Col span={24} className="card-box">
        <Card
          cover={
            <div className="cover-img" style={secondStyle} />
          }
          className="card-item"
        >
